var canvas = document.getElementById("myCanvas"); // referrencing canvas element into variable
...
document.addEventListener("keyup", keyUpHandler, false); 
 ...
 function get_random_color() {
    var letters = 'ABCDEF'.split(''); // ['A','B','C'..]
    var color = "#";
    for (var i =0;i<3;i++) {
...
if (y + dy < ballRadius ) {
    ...
    var r = confirm(`Game over! Final score: ${score} Press 'Start' to restart`) 
